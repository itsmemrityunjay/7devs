                        ...
                        {serviceCategories.map((service, index) => (
                            <div key={index} className='border-b border-white'>
                                ...
                                <button
                                    ...
                                    className='w-full flex justify-between items-center py-8 text-left hover:opacity-70 transition-all duration-300 group'
                                >
                                    <h3 className='text-4xl md:text-6xl font-bold text-white tracking-tight group-hover:text-red-500 transition-colors duration-300'>
                                        {service.title}
                                    </h3>
                                    <div className='text-white text-4xl font-light group-hover:text-red-500 transition-colors duration-300'>
