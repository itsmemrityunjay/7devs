...
const Clients = () => {
  ...
  },
  {
    type: "profile",
    name: "James Wilson",
    imageUrl: "https://images.unsplash.com/photo-1551862390-7894b509f8ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGxlYWRlciUyMHBvcnRyYWl0fGVufDF8fHx8MTc1ODI3NTk4Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    bgColor: "bg-red-500"
  },
  {
    type: "brand",
    ...
    <section id="clients" className="min-h-screen bg-gray-50 py-20 px-4 sm:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center mb-8 md:mb-16">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-black mb-4 md:mb-6 leading-tight">
          Digital solutions with <span className="text-red-500">impact</span>,
          <br className="hidden sm:block" />
          built for businesses like <span className="text-red-500">yours</span>
        </h2>
